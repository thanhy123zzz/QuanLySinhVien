...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
	<div
		...
		<a class="navbar-brand brand-logo mr-5"
			href="/QuanLySinhVien/trang-chu"><img
			src="<c:url value="/tamplate/images/Method Draw Image.png" />"
			class="mr-2" alt="logo" /></a> <a class="navbar-brand brand-logo-mini"
			href="/QuanLySinhVien/trang-chu"><img
			src="<c:url value="/tamplate/images/logo1.svg" />" alt="logo" /></a>
	</div>
	<div
		...
		<ul class="navbar-nav mr-lg-2">
			<li class="nav-item nav-search d-none d-lg-block">
				<form action="/QuanLySinhVien/trang-chu/tim-kiem" method="get">
					<div class="input-group">
						...
						<input name ="search" type="text" class="form-control" id="navbar-search-input"
		...
		<ul class="navbar-nav navbar-nav-right">
			<li class="nav-item dropdown"><a
				...
				id="notificationDropdown" href="#" data-toggle="dropdown"> <i
					class="icon-bell mx-0"></i> <span class="count"></span></a>
				<div
			...
			<li class="nav-item nav-profile dropdown"><a
				...
				id="profileDropdown"><img
					src="<c:url value="/tamplate/images/admin.png" />" alt="profile" />
			</a>
				<div class="dropdown-menu dropdown-menu-right navbar-dropdown"
					aria-labelledby="profileDropdown">
					<a class="dropdown-item"> <i class="ti-settings text-primary"></i>
						Cài đặt
					</a> <a class="dropdown-item" href="/QuanLySinhVien/dang-xuat"> <i
